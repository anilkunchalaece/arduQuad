...
pidRollRateSetPoint = pidRollRateSetPoint / 3 ;// the max roll rate is aprox 164 degrees per second (500/3 = 165 d/s )
...
pidPitchRateSetPoint = pidPitchRateSetPoint / 3;
...
pidYawRateSetPoint = pidYawRateSetPoint / 3;
